...
ORDER BY PaymentDate, LocalReceiptID;";
            ...
            while (await rd.ReadAsync(cancellationToken))
            {
                var draft = new LocalReceiptDraftDto
                {
                    ...
                    ServerImportID = rd.IsDBNull(11) ? null : rd.GetInt32(11),
                    ...
                    UpdatedAt = rd.IsDBNull(15) ? null : DateTime.Parse(rd.GetString(15)),
                    SentAt = rd.IsDBNull(16) ? null : DateTime.Parse(rd.GetString(16))
                };
...
ORDER BY LocalReceiptLineID;";
            ...
            while (await rd.ReadAsync(cancellationToken))
            {
                lines.Add(new LocalReceiptDraftLineDto
                {
                    ...
                    InvoiceID = rd.IsDBNull(2) ? null : rd.GetInt32(2),
